...
//        app_scan_param.op.code = GAPM_SCAN_ACTIVE;   //set scan params
//        app_scan_param.op.addr_src = GAPM_STATIC_ADDR;
//        app_scan_param.interval = 160;
//        app_scan_param.window = 160;
//        app_scan_param.mode = GAP_OBSERVER_MODE;
//        app_scan_param.filter_duplic = SCAN_FILT_DUPLIC_DIS; //filtering rule
//        app_scan_param.filt_policy = SCAN_ALLOW_ADV_ALL;

//        bx_dwork( ( void ( * )( void * ) )ble_scan_start, &app_scan_param, 1000, 1 );  //Scanning starts after 1s
    } else {
...
//    {GAPM_ADV_REPORT_IND,       ( ke_msg_func_t )app_on_scan_adv_report},
    {GAPM_ADV_REPORT_IND,       ( ke_msg_func_t )GetAdvReport},     // Changed by wude
};
