...
#define PTS_SVC_UUID_128         {0xFB, 0x34, 0x9B, 0x5F, 0x80, 0x00, 0x00, 0x80, \
								0x00, 0x10, 0x00, 0x00, 0xF0, 0xFE, 0x00, 0x00}

#define PTS_SVC_IDX_ALM_2_ATT_CHAR_UUID_128 {0xFB, 0x34, 0x9B, 0x5F, 0x80, 0x00, 0x00, 0x80, \
								0x00, 0x10, 0x00, 0x00, 0x01, 0xFE, 0x00, 0x00}

#define PTS_SVC_IDX_ALM_1_ATT_CHAR_UUID_128 {0xFB, 0x34, 0x9B, 0x5F, 0x80, 0x00, 0x00, 0x80, \
								0x00, 0x10, 0x00, 0x00, 0x40, 0xFE, 0x00, 0x00}

#define PTS_SVC_IDX_ALM_ATT_CHAR_UUID_128 {0xFB, 0x34, 0x9B, 0x5F, 0x80, 0x00, 0x00, 0x80, \
								0x00, 0x10, 0x00, 0x00, 0x20, 0xFE, 0x00, 0x00}


#define PTS_SVC_IDX_SET_ADV_CHAR_UUID_128 {0xFB, 0x34, 0x9B, 0x5F, 0x80, 0x00, 0x00, 0x80, \
								0x00, 0x10, 0x00, 0x00, 0x51, 0xFE, 0x00, 0x00}

#define SET_FILTER_CHAR_UUID_128 {0xFB, 0x34, 0x9B, 0x5F, 0x80, 0x00, 0x00, 0x80, \
								0x00, 0x10, 0x00, 0x00, 0x52, 0xFE, 0x00, 0x00}

#define PTS_SVC_TX_CHAR_UUID_128 {0xFB, 0x34, 0x9B, 0x5F, 0x80, 0x00, 0x00, 0x80, \
...
//------------------0xFF20-------------------------	
    [PTS_SVC_IDX_ALM_ATT_CHAR] = {
        .uuid = ATT_DECL_CHAR_ARRAY,
        .perm = PERM(RD,ENABLE),
        .max_size = 0,
        .ext_perm= PERM(UUID_LEN,UUID_16),
    },
    [PTS_SVC_IDX_ALM_ATT_VAL] = {
        .uuid = PTS_SVC_IDX_ALM_ATT_CHAR_UUID_128,
        .perm = PERM(WRITE_REQ,ENABLE)|PERM(WRITE_COMMAND,ENABLE)|PERM(WP,NO_AUTH)|PERM(RD, ENABLE),
        .max_size = PTS_SVC_RX_BUF_SIZE,
        .ext_perm = PERM(UUID_LEN,UUID_128)|PERM(RI,ENABLE),
    },
//------------------0xFF40--------------------	
	[PTS_SVC_IDX_ALM_ATT_CHAR_1] = {
        .uuid = ATT_DECL_CHAR_ARRAY,
        .perm = PERM(RD,ENABLE),
        .max_size = 0,
        .ext_perm= PERM(UUID_LEN,UUID_16),
    },
    [PTS_SVC_IDX_ALM_ATT_VAL_1] = {
        .uuid = PTS_SVC_IDX_ALM_1_ATT_CHAR_UUID_128,
        .perm = PERM(WRITE_REQ,ENABLE)|PERM(WRITE_COMMAND,ENABLE)|PERM(WP,NO_AUTH)|PERM(RD, ENABLE),
        .max_size = PTS_SVC_RX_BUF_SIZE,
        .ext_perm = PERM(UUID_LEN,UUID_128)|PERM(RI,ENABLE),
    },
//---------------------0xFE01----------------------	
	[PTS_SVC_IDX_ALM_ATT_CHAR_2] = {
        .uuid = ATT_DECL_CHAR_ARRAY,
        .perm = PERM(RD,ENABLE),
        .max_size = 0,
        .ext_perm= PERM(UUID_LEN,UUID_16),
    },
    [PTS_SVC_IDX_ALM_ATT_VAL_2] = {
        .uuid = PTS_SVC_IDX_ALM_2_ATT_CHAR_UUID_128,
        .perm = PERM(RD, ENABLE),
        .max_size = PTS_SVC_RX_BUF_SIZE,
        .ext_perm = PERM(UUID_LEN,UUID_128)|PERM(RI,ENABLE),
    },
...
//-----------------------------------------------------	
//    [PTS_SVC_IDX_SET_ADV_CHAR] = {
//        .uuid = ATT_DECL_CHAR_ARRAY,
//        .perm = PERM(RD,ENABLE),
//        .max_size = 0,
//        .ext_perm = PERM(UUID_LEN,UUID_16),
//    },
//    [PTS_SVC_IDX_SET_ADV_VAL] = {

//        .uuid = PTS_SVC_IDX_SET_ADV_CHAR_UUID_128,
...
//    [PTS_SVC_IDX_SET_FILTER_CHAR] = {
//        .uuid = ATT_DECL_CHAR_ARRAY,
//        .perm = PERM(RD,ENABLE),
//        .max_size = 0,
//        .ext_perm = PERM(UUID_LEN,UUID_16),
//    },
//    [PTS_SVC_IDX_SET_FILTER_VAL] = {

//        .uuid = SET_FILTER_CHAR_UUID_128,
//        .perm = PERM(WRITE_REQ, ENABLE),
//        .max_size = PTS_SVC_RX_BUF_SIZE,
//        .ext_perm = PERM(UUID_LEN,UUID_128)|PERM(RI,ENABLE),
//    },
 ...
 */
/**
 @brief 添加alm profile函数
 @param  无
 @return 无
*/
void User_Add_AlmProfile(void)
{
//    struct test_db_cfg* db_cfg;
    // Allocate the DISS_CREATE_DB_REQ
//    struct gapm_profile_task_add_cmd *req = KE_MSG_ALLOC_DYN(GAPM_PROFILE_TASK_ADD_CMD,
//                                                  TASK_GAPM, TASK_APP,
//                                                  gapm_profile_task_add_cmd,sizeof(test_db_cfg));
    ...
    req->prf_task_id = TASK_ID_ALMPROFILE;
